...
% Форматирование стандартных заголовков
%\usepackage{titlesec}
...
\newcommand{\problem}{%
	...
	\paragraph{Задание \arabic{section}.\arabic{problemcounter}}%
}

%\newcounter{problemcounter}[section]
%\newcommand{\problem}{%
%	\addtocounter{problemcounter}{1}%
%	{\noindent\bf Задание \arabic{section}.\arabic{problemcounter}\hspace{0.3cm}}%
%}
